...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength) {
            var sCSSClass = "text_filter  input-sm";
            if (bIsNumber)
                sCSSClass = "number_filter input-sm";
        ...
        return this.each(function () {
            ...
            var sFilterRow = "#" + oTable[0].id + "Wrapper .dataTables_scrollHeadInner table thead tr:first";

            $(sFilterRow + " th").each(function (index) {
                i = index;
